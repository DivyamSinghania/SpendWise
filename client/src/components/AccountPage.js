...
export default function AccountPage({ 
    ...
    const handleProfilePicChange = (e) => {
        ...
        if (file) {
            setProfilePic(file);
            // Create preview URL so user can see selected image
    ...
    // ── UPDATED: Signup now sends FormData for file upload ──
    const handleSignup = async (event) => {
        event.preventDefault();
        setAuthLoading(true);
        
        // Use FormData instead of plain JSON
        // because we need to send a file
        const formData = new FormData();
        formData.append('name', signupForm.name);
        formData.append('email', signupForm.email);
        formData.append('password', signupForm.password);
        
        // Only append profilePic if user selected one
        if (profilePic) {
            ...
            <div className="account-wrap">
                ...
                <div className="card account-card">
                    <div className="account-profile">
                        ...
                        {/* Show profile pic or initial avatar */}
                        {user.profilePic ? (
                            <img
